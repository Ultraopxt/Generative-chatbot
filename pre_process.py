...
class Corpus:
    #初始化
    def __init__(self, filePath , maxSentenceWordsNum=-1 , id2word=None, word2id=None, wordNum=None,tfidf=False,QIDF=None,testSize=0.2, isCharVec=False):
    ...
    def random_batch_data_stream(self, batchSize=128, isDataEnhance=False, dataEnhanceRatio=0.2, type='train'):
        # 判断数据是不是训练数据，另外给定结束符eos.只有训练集需要随机打乱
